...
export async function PUT(
  ...
  // Aceitamos no mínimo { content }, mas permitimos title/description opcionais
  ...
  // upsert para garantir existência
  const saved = await prisma.app_prompt.upsert({
    ...
    create: {
      ...
      description: typeof payload.description !== "undefined" ? payload.description : null,
      content: payload.content,
      updated_by: Number.isFinite(userIdNum) ? userIdNum : null,
    },
    select: {
