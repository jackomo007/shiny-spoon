...
export default function DashboardShell({ children }: Props) {
  ...
  const tradingGroupActive = useMemo(
    () =>
      isPathActive(pathname, "/journal") ||
      isPathActive(pathname, "/manage-tags") ||
      isPathActive(pathname, "/strategies") ||
      isPathActive(pathname, "/chart-tracker") ||
      isPathActive(pathname, "/trade-analyzer") ||
      isPathActive(pathname, "/exit-strategy"),
    [pathname],
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              className={`whitespace-nowrap text-xl font-black tracking-[-0.04em] transition-opacity ${
        ...
        >
          ...
          <div className="mt-[18px]">
            ...
            >
              ...
              <SubNavItem
                href="/manage-tags"
                label="Manage Tags"
                active={isPathActive(pathname, "/manage-tags")}
              />
              <SubNavItem
                href="/strategies"
                label="Strategies"
                active={isPathActive(pathname, "/strategies")}
              />
              <SubNavItem
                href="/trade-analyzer"
                label="Trade Analyzer"
                active={isPathActive(pathname, "/trade-analyzer")}
              />
              <SubNavItem
                href="/exit-strategy"
                label="Exit Strategy"
                active={isPathActive(pathname, "/exit-strategy")}
              />
              <SubNavItem
                href="/chart-tracker"
                label="Chart Tracker"
                active={isPathActive(pathname, "/chart-tracker")}
              />
            </NavGroup>
          </div>
          ...
          >
            ...
            <NavItem
              ...
              icon={<SearchIcon />}
              collapsed={sidebarCollapsed}
              active={isPathActive(pathname, "/add-coin")}
            />
          </SidebarSection>
        </div>
